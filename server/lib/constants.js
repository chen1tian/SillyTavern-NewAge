...
const EVENTS = {
  ...
  MEMBER_JOINED: 'MEMBER_JOINED', // 冗余，与 ROOM_JOINED 相同，但更语义化 (用于成员管理模块)
  MEMBER_LEFT: 'MEMBER_LEFT',     // 冗余，与 ROOM_LEFT 相同，但更语义化 (用于成员管理模块)
  ...
  CONNECTION_POLICY_GET: 'CONNECTION_POLICY_GET',
...
// 导出时按字母顺序排列，方便查找
export { EVENTS, NAMESPACES, STREAM_EVENTS };